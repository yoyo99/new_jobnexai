...
const JobApplications = React.lazy(() =>
  import("../components/JobApplications")
);
...
const MarketTrendsPage = React.lazy(() =>
  import("../components/pages/MarketTrendsPage")
);
const FreelanceProjects = React.lazy(() =>
  import("../components/freelance/FreelanceProjects")
);
const FreelanceProfile = React.lazy(() =>
  import("../components/freelance/FreelanceProfile")
);
const RecruiterDashboard = React.lazy(() =>
  import("../components/recruiter/RecruiterDashboard")
);
const CandidateSearch = React.lazy(() =>
  import("../components/recruiter/CandidateSearch")
);
const JobPostings = React.lazy(() =>
  import("../components/recruiter/JobPostings")
);
const CreateJobPosting = React.lazy(() =>
  import("../components/recruiter/CreateJobPosting")
);
const CoverLetterGenerator = React.lazy(() =>
  import("../components/applications/CoverLetterGenerator").then((module) => ({
    default: module.CoverLetterGenerator,
  }))
);
const UserCoverLetters = React.lazy(() =>
  import("../components/applications/UserCoverLetters")
);
const FranceTravailPage = React.lazy(() =>
  import("../pages/FranceTravailPage")
);
