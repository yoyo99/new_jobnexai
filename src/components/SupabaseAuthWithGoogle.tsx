...
const SupabaseAuthWithGoogle: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-auth-gradient py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      >
        ...
        {/* NOUVEAU : Bouton Google ajouté ici */}
        <div className="space-y-4">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-background/80 text-gray-400">
                {t('auth.orContinueWith', 'ou continuer avec email')}
              </span>
            </div>
          </div>
        </div>
...
export default SupabaseAuthWithGoogle;